...
const InsertMedicalRecordModal = ({ visible, setShowModalAppointment, ...rest }) => {
  return (
    <Modal {...rest} visible={visible} transparent={true} animationType="fade">
      <PatientModal2>
        ...
        <ImagePatientModal source={require("../../assets/imagemPaciente2.png")} />

          <TextPatient3>Niccole Sarga</TextPatient3>
        <TextPatient>22 anos  niccole.sarga@gmail.com</TextPatient>

          <ButtonModal2 onPress={() => setShowModalAppointment(false)}>
